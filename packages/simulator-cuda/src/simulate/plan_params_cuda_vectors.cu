...
template <typename T> std::vector<T> get_vector(T *ptr, uint32_t len) {
...
get_plan_params_cuda_vectors(const PlanParamsCuda_C_Arrays &c_arrays,
  ...
  auto future_savings_by_mfn =
      get_vector(c_arrays.future_savings_by_mfn, num_months);
  auto income_during_retirement_by_mfn =
      get_vector(c_arrays.income_during_retirement_by_mfn, num_months);
  ...
  return PlanParamsCuda_Vectors{
      ...
      .essential_expenses_by_mfn =
          get_vector(c_arrays.essential_expenses_by_mfn, num_months),
      .discretionary_expenses_by_mfn =
          get_vector(c_arrays.discretionary_expenses_by_mfn, num_months),
      .tpaw_rra_including_pos_infinity_by_mfn = get_vector(
          c_arrays.tpaw_rra_including_pos_infinity_by_mfn, num_months),
      .spaw_spending_tilt_by_mfn =
          get_vector(c_arrays.spaw_spending_tilt_by_mfn, num_months),
      .spaw_and_swr_stock_allocation_savings_portfolio_by_mfn = get_vector(
          c_arrays.spaw_and_swr_stock_allocation_savings_portfolio_by_mfn,
          num_months),
      .percentiles = get_vector(c_arrays.percentiles, c_arrays.num_percentiles),
      .historical_returns_series =
          get_vector(c_arrays.historical_returns_series,
