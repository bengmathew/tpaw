...
impl From<SimulationResultArrays> for WireSimulationResultArrays {
    fn from(other: SimulationResultArrays) -> Self {
        Self {
            ...
            tpaw_by_percentile_by_mfn_simulated_percentile_major_spending_tilt_x10000000: other.tpaw_by_percentile_by_mfn_simulated_percentile_major_spending_tilt.to_float_wire(10000000),
