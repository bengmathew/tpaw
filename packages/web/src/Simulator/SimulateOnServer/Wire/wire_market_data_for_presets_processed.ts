...
export const WireDailyMarketDataForPresetsSP500: MessageFns<WireDailyMarketDataForPresetsSP500> = {
  ...
  fromJSON(object: any): WireDailyMarketDataForPresetsSP500 {
    return {
      closingTimestampMs: isSet(object.closingTimestampMs)
        ? globalThis.Number(object.closingTimestampMs)
        : isSet(object.closing_timestamp_ms)
        ? globalThis.Number(object.closing_timestamp_ms)
        : 0,
  ...
  fromJSON(object: any): WireDailyMarketDataForPresetsBondRates {
    return {
      closingTimestampMs: isSet(object.closingTimestampMs)
        ...
        ? globalThis.Number(object.closing_timestamp_ms)
        : 0,
      fiveYear: isSet(object.fiveYear)
        ? globalThis.Number(object.fiveYear)
        : isSet(object.five_year)
        ? globalThis.Number(object.five_year)
        : 0,
      sevenYear: isSet(object.sevenYear)
        ? globalThis.Number(object.sevenYear)
        : isSet(object.seven_year)
        ? globalThis.Number(object.seven_year)
        : 0,
      tenYear: isSet(object.tenYear)
        ? globalThis.Number(object.tenYear)
        : isSet(object.ten_year)
        ? globalThis.Number(object.ten_year)
        : 0,
      twentyYear: isSet(object.twentyYear)
        ? globalThis.Number(object.twentyYear)
        : isSet(object.twenty_year)
        ? globalThis.Number(object.twenty_year)
        : 0,
      thirtyYear: isSet(object.thirtyYear)
        ? globalThis.Number(object.thirtyYear)
        : isSet(object.thirty_year)
        ? globalThis.Number(object.thirty_year)
        : 0,
    };
  },
  ...
  fromJSON(object: any): WireDailyMarketDataForPresets {
    return {
      ...
      bondRates: isSet(object.bondRates)
        ...
        : isSet(object.bond_rates)
        ? WireDailyMarketDataForPresetsBondRates.fromJSON(object.bond_rates)
        : undefined,
...
> = {
  ...
  fromJSON(object: any): WireAverageAnnualRealEarningsForSP500For10Years {
    return {
      addedDateMs: isSet(object.addedDateMs)
        ? globalThis.Number(object.addedDateMs)
        : isSet(object.added_date_ms)
        ? globalThis.Number(object.added_date_ms)
        : 0,
      tenYearDuration: isSet(object.tenYearDuration)
        ? WireTenYearDuration.fromJSON(object.tenYearDuration)
        : isSet(object.ten_year_duration)
        ? WireTenYearDuration.fromJSON(object.ten_year_duration)
        : undefined,
      value: isSet(object.value) ? globalThis.Number(object.value) : 0,
    };
  },
  ...
  fromJSON(object: any): WireMarketDataForPresetsProcessedSource {
    return {
      dailyMarketData: isSet(object.dailyMarketData)
        ...
        : isSet(object.daily_market_data)
        ? WireDailyMarketDataForPresets.fromJSON(object.daily_market_data)
        : undefined,
      averageAnnualRealEarningsForSp500For10Years: isSet(object.averageAnnualRealEarningsForSp500For10Years)
        ...
        : isSet(object.average_annual_real_earnings_for_sp500_for_10_years)
        ? WireAverageAnnualRealEarningsForSP500For10Years.fromJSON(
          object.average_annual_real_earnings_for_sp500_for_10_years,
        )
        : undefined,
    };
  },
...
export const WireMarketDataForPresetsProcessedStocks: MessageFns<WireMarketDataForPresetsProcessedStocks> = {
  ...
  fromJSON(object: any): WireMarketDataForPresetsProcessedStocks {
    return {
      capeNotRounded: isSet(object.capeNotRounded)
        ? globalThis.Number(object.capeNotRounded)
        : isSet(object.cape_not_rounded)
        ? globalThis.Number(object.cape_not_rounded)
        : 0,
      oneOverCapeNotRounded: isSet(object.oneOverCapeNotRounded)
        ? globalThis.Number(object.oneOverCapeNotRounded)
        : isSet(object.one_over_cape_not_rounded)
        ? globalThis.Number(object.one_over_cape_not_rounded)
        : 0,
      oneOverCapeRounded: isSet(object.oneOverCapeRounded)
        ? globalThis.Number(object.oneOverCapeRounded)
        : isSet(object.one_over_cape_rounded)
        ? globalThis.Number(object.one_over_cape_rounded)
        : 0,
      empiricalAnnualNonLogRegressionsStocks: isSet(object.empiricalAnnualNonLogRegressionsStocks)
        ...
        : isSet(object.empirical_annual_non_log_regressions_stocks)
        ? WireCAPEBasedRegressionResults.fromJSON(object.empirical_annual_non_log_regressions_stocks)
        : undefined,
      regressionPrediction: isSet(object.regressionPrediction)
        ? globalThis.Number(object.regressionPrediction)
        : isSet(object.regression_prediction)
        ? globalThis.Number(object.regression_prediction)
        : 0,
      conservativeEstimate: isSet(object.conservativeEstimate)
        ? globalThis.Number(object.conservativeEstimate)
        : isSet(object.conservative_estimate)
        ? globalThis.Number(object.conservative_estimate)
        : 0,
...
export const WireMarketDataForPresetsProcessedBonds: MessageFns<WireMarketDataForPresetsProcessedBonds> = {
  ...
  fromJSON(object: any): WireMarketDataForPresetsProcessedBonds {
    return {
      tipsYield20Year: isSet(object.tipsYield20Year)
        ? globalThis.Number(object.tipsYield20Year)
        : isSet(object.tips_yield_20_year)
        ? globalThis.Number(object.tips_yield_20_year)
        : 0,
      historical: isSet(object.historical) ? globalThis.Number(object.historical) : 0,
    };
  },
...
export const WireMarketDataForPresetsProcessedInflation: MessageFns<WireMarketDataForPresetsProcessedInflation> = {
  ...
  fromJSON(object: any): WireMarketDataForPresetsProcessedInflation {
    return {
      suggestedAnnual: isSet(object.suggestedAnnual)
        ? globalThis.Number(object.suggestedAnnual)
        : isSet(object.suggested_annual)
        ? globalThis.Number(object.suggested_annual)
        : 0,
    };
  },
  ...
  fromJSON(object: any): WireMarketDataForPresetsProcessed {
    return {
      sourceRounded: isSet(object.sourceRounded)
        ...
        : isSet(object.source_rounded)
        ? WireMarketDataForPresetsProcessedSource.fromJSON(object.source_rounded)
        : undefined,
      expectedReturns: isSet(object.expectedReturns)
        ...
        : isSet(object.expected_returns)
        ? WireMarketDataForPresetsProcessedExpectedReturns.fromJSON(object.expected_returns)
        : undefined,
      inflation: isSet(object.inflation)
