...
export const WireDailyMarketDataForPresetsSP500 = {
  encode(message: WireDailyMarketDataForPresetsSP500, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireDailyMarketDataForPresetsSP500 {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.closingTimestampMs = longToNumber(reader.int64() as Long);
          continue;
        case 2:
          if (tag !== 17) {
            break;
...
export const WireDailyMarketDataForPresetsBondRates = {
  encode(message: WireDailyMarketDataForPresetsBondRates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.closingTimestampMs !== 0) {
      writer.uint32(8).int64(message.closingTimestampMs);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireDailyMarketDataForPresetsBondRates {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireDailyMarketDataForPresetsInflation = {
  encode(message: WireDailyMarketDataForPresetsInflation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.closingTimestampMs !== 0) {
      writer.uint32(8).int64(message.closingTimestampMs);
    }
    if (message.value !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireDailyMarketDataForPresetsInflation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireDailyMarketDataForPresets = {
  encode(message: WireDailyMarketDataForPresets, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.closingTimestampMs !== 0) {
      writer.uint32(8).int64(message.closingTimestampMs);
    }
    if (message.sp500 !== undefined) {
      WireDailyMarketDataForPresetsSP500.encode(message.sp500, writer.uint32(18).fork()).ldelim();
    }
    if (message.bondRates !== undefined) {
      WireDailyMarketDataForPresetsBondRates.encode(message.bondRates, writer.uint32(26).fork()).ldelim();
    }
    if (message.inflation !== undefined) {
      WireDailyMarketDataForPresetsInflation.encode(message.inflation, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireDailyMarketDataForPresets {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireTenYearDuration = {
  encode(message: WireTenYearDuration, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireTenYearDuration {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireAverageAnnualRealEarningsForSP500For10Years = {
  encode(
    ...
    if (message.tenYearDuration !== undefined) {
      WireTenYearDuration.encode(message.tenYearDuration, writer.uint32(18).fork()).ldelim();
    }
    if (message.value !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireAverageAnnualRealEarningsForSP500For10Years {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.addedDateMs = longToNumber(reader.int64() as Long);
          continue;
        case 2:
          if (tag !== 18) {
            break;
...
export const WireMarketDataForPresetsProcessedSource = {
  encode(message: WireMarketDataForPresetsProcessedSource, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.dailyMarketData !== undefined) {
      WireDailyMarketDataForPresets.encode(message.dailyMarketData, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessedSource {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireFiveTenTwentyThirtyYearsF64 = {
  encode(message: WireFiveTenTwentyThirtyYearsF64, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.fiveYear !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireFiveTenTwentyThirtyYearsF64 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireCAPEBasedRegressionResults = {
  encode(message: WireCAPEBasedRegressionResults, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.full !== undefined) {
      WireFiveTenTwentyThirtyYearsF64.encode(message.full, writer.uint32(10).fork()).ldelim();
    }
    if (message.restricted !== undefined) {
      WireFiveTenTwentyThirtyYearsF64.encode(message.restricted, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireCAPEBasedRegressionResults {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireMarketDataForPresetsProcessedStocks = {
  encode(message: WireMarketDataForPresetsProcessedStocks, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessedStocks {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireMarketDataForPresetsProcessedBonds = {
  encode(message: WireMarketDataForPresetsProcessedBonds, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessedBonds {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireMarketDataForPresetsProcessedExpectedReturns = {
  encode(
    message: WireMarketDataForPresetsProcessedExpectedReturns,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.stocks !== undefined) {
      WireMarketDataForPresetsProcessedStocks.encode(message.stocks, writer.uint32(10).fork()).ldelim();
    }
    if (message.bonds !== undefined) {
      WireMarketDataForPresetsProcessedBonds.encode(message.bonds, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessedExpectedReturns {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireMarketDataForPresetsProcessedInflation = {
  encode(message: WireMarketDataForPresetsProcessedInflation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessedInflation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireMarketDataForPresetsProcessed = {
  encode(message: WireMarketDataForPresetsProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sourceRounded !== undefined) {
      WireMarketDataForPresetsProcessedSource.encode(message.sourceRounded, writer.uint32(10).fork()).ldelim();
    }
    if (message.expectedReturns !== undefined) {
      WireMarketDataForPresetsProcessedExpectedReturns.encode(message.expectedReturns, writer.uint32(18).fork())
        .ldelim();
    }
    if (message.inflation !== undefined) {
      WireMarketDataForPresetsProcessedInflation.encode(message.inflation, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireMarketDataForPresetsProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
