...
export interface WireSimulationResultArrays {
  ...
  tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000: number[];
...
export const WireMarketDailySeriesSrcSyntheticConstant: MessageFns<WireMarketDailySeriesSrcSyntheticConstant> = {
  encode(message: WireMarketDailySeriesSrcSyntheticConstant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireMarketDailySeriesSrcSyntheticConstant {
  ...
  fromJSON(object: any): WireMarketDailySeriesSrcSyntheticConstant {
    return {
      annualPercentageChangeVt: isSet(object.annualPercentageChangeVt)
        ...
        : isSet(object.annual_percentage_change_vt)
        ? globalThis.Number(object.annual_percentage_change_vt)
        : 0,
      annualPercentageChangeBnd: isSet(object.annualPercentageChangeBnd)
        ? globalThis.Number(object.annualPercentageChangeBnd)
        : isSet(object.annual_percentage_change_bnd)
        ? globalThis.Number(object.annual_percentage_change_bnd)
        : 0,
    };
  },
...
export const WireSimulationArgs: MessageFns<WireSimulationArgs> = {
  encode(message: WireSimulationArgs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.marketDailySeriesSrc?.$case) {
      case "live":
        NoMessage.encode(message.marketDailySeriesSrc.live, writer.uint32(26).fork()).join();
        break;
      case "syntheticLiveRepeated":
        NoMessage.encode(message.marketDailySeriesSrc.syntheticLiveRepeated, writer.uint32(34).fork()).join();
        break;
    ...
    if (message.planParams !== undefined) {
      WirePlanParamsServer.encode(message.planParams, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WireSimulationArgs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.timestampForMarketDataMs = longToNumber(reader.int64());
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): WireSimulationArgs {
    return {
      currentPortfolioBalance: isSet(object.estimate)
        ...
        : isSet(object.no_estimate)
        ? { $case: "noEstimate", noEstimate: globalThis.Number(object.no_estimate) }
        : undefined,
      marketDailySeriesSrc: isSet(object.live)
        ...
        : isSet(object.synthetic_live_repeated)
        ? { $case: "syntheticLiveRepeated", syntheticLiveRepeated: NoMessage.fromJSON(object.synthetic_live_repeated) }
        ...
        : isSet(object.synthetic_constant)
        ? {
          $case: "syntheticConstant",
          syntheticConstant: WireMarketDailySeriesSrcSyntheticConstant.fromJSON(object.synthetic_constant),
        }
        : undefined,
      ...
      timestampForMarketDataMs: isSet(object.timestampForMarketDataMs)
        ...
        : isSet(object.timestamp_for_market_data_ms)
        ? globalThis.Number(object.timestamp_for_market_data_ms)
        : 0,
      planParams: isSet(object.planParams)
        ? WirePlanParamsServer.fromJSON(object.planParams)
        : isSet(object.plan_params)
        ? WirePlanParamsServer.fromJSON(object.plan_params)
        : undefined,
    };
  },
  ...
  toJSON(message: WireSimulationArgs): unknown {
    ...
    } else if (message.currentPortfolioBalance?.$case === "noEstimate") {
    ...
    } else if (message.marketDailySeriesSrc?.$case === "syntheticLiveRepeated") {
      obj.syntheticLiveRepeated = NoMessage.toJSON(message.marketDailySeriesSrc.syntheticLiveRepeated);
    } else if (message.marketDailySeriesSrc?.$case === "syntheticConstant") {
  ...
  fromPartial<I extends Exact<DeepPartial<WireSimulationArgs>, I>>(object: I): WireSimulationArgs {
    const message = createBaseWireSimulationArgs();
    switch (object.currentPortfolioBalance?.$case) {
      case "estimate": {
        if (
          object.currentPortfolioBalance?.estimate !== undefined && object.currentPortfolioBalance?.estimate !== null
        ) {
          message.currentPortfolioBalance = {
            $case: "estimate",
      ...
      case "noEstimate": {
        if (
          ...
          message.currentPortfolioBalance = {
            $case: "noEstimate",
            noEstimate: object.currentPortfolioBalance.noEstimate,
          };
        }
        break;
      }
    }
    switch (object.marketDailySeriesSrc?.$case) {
      case "live": {
        if (object.marketDailySeriesSrc?.live !== undefined && object.marketDailySeriesSrc?.live !== null) {
          message.marketDailySeriesSrc = {
            $case: "live",
            live: NoMessage.fromPartial(object.marketDailySeriesSrc.live),
          };
        }
        break;
      }
...
function createBaseWireSimulationResultArrays(): WireSimulationResultArrays {
  return {
    ...
    tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000: [],
    byPercentileEndingBalance: [],
  };
}

export const WireSimulationResultArrays: MessageFns<WireSimulationResultArrays> = {
  encode(message: WireSimulationResultArrays, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (
      ...
      writer.uint32(64).int64(v!);
    }
    for (const v of message.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000) {
      writer.uint32(72).int64(v!);
    }
    for (const v of message.byPercentileEndingBalance) {
      writer.uint32(81).double(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WireSimulationResultArrays {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          if (tag === 8) {
            message.byPercentileByMfnSimulatedPercentileMajorBalanceStartX100.push(longToNumber(reader.int64()));
        ...
        case 4: {
          if (tag === 32) {
            message.byPercentileByMfnSimulatedPercentileMajorWithdrawalsGeneralX100.push(longToNumber(reader.int64()));
        ...
        case 5: {
          if (tag === 40) {
            message.byPercentileByMfnSimulatedPercentileMajorWithdrawalsTotalX100.push(longToNumber(reader.int64()));
        ...
        case 8: {
          if (tag === 64) {
            message
              .byPercentileByMfnSimulatedPercentileMajorAfterWithdrawalsAllocationTotalPortfolioOrZeroIfNoWealthX10000
              .push(longToNumber(reader.int64()));
        ...
        case 9: {
          if (tag === 72) {
            message.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000.push(
              longToNumber(reader.int64()),
            );
    ...
    return {
      byPercentileByMfnSimulatedPercentileMajorBalanceStartX100:
        globalThis.Array.isArray(object?.byPercentileByMfnSimulatedPercentileMajorBalanceStartX100)
          ...
          : globalThis.Array.isArray(object?.by_percentile_by_mfn_simulated_percentile_major_balance_start_x100)
          ? object.by_percentile_by_mfn_simulated_percentile_major_balance_start_x100.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileByMfnSimulatedPercentileMajorWithdrawalsEssentialX100:
        globalThis.Array.isArray(object?.byPercentileByMfnSimulatedPercentileMajorWithdrawalsEssentialX100)
          ...
          : globalThis.Array.isArray(object?.by_percentile_by_mfn_simulated_percentile_major_withdrawals_essential_x100)
          ? object.by_percentile_by_mfn_simulated_percentile_major_withdrawals_essential_x100.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileByMfnSimulatedPercentileMajorWithdrawalsDiscretionaryX100:
        globalThis.Array.isArray(object?.byPercentileByMfnSimulatedPercentileMajorWithdrawalsDiscretionaryX100)
          ...
          : globalThis.Array.isArray(
              object?.by_percentile_by_mfn_simulated_percentile_major_withdrawals_discretionary_x100,
            )
          ? object.by_percentile_by_mfn_simulated_percentile_major_withdrawals_discretionary_x100.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileByMfnSimulatedPercentileMajorWithdrawalsGeneralX100:
        globalThis.Array.isArray(object?.byPercentileByMfnSimulatedPercentileMajorWithdrawalsGeneralX100)
          ...
          : globalThis.Array.isArray(object?.by_percentile_by_mfn_simulated_percentile_major_withdrawals_general_x100)
          ? object.by_percentile_by_mfn_simulated_percentile_major_withdrawals_general_x100.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileByMfnSimulatedPercentileMajorWithdrawalsTotalX100:
        globalThis.Array.isArray(object?.byPercentileByMfnSimulatedPercentileMajorWithdrawalsTotalX100)
          ...
          : globalThis.Array.isArray(object?.by_percentile_by_mfn_simulated_percentile_major_withdrawals_total_x100)
          ? object.by_percentile_by_mfn_simulated_percentile_major_withdrawals_total_x100.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileByMfnSimulatedPercentileMajorWithdrawalsFromSavingsPortfolioRateX10000:
        globalThis.Array.isArray(
          ...
          : globalThis.Array.isArray(
              object?.by_percentile_by_mfn_simulated_percentile_major_withdrawals_from_savings_portfolio_rate_x10000,
            )
          ? object.by_percentile_by_mfn_simulated_percentile_major_withdrawals_from_savings_portfolio_rate_x10000.map((
            e: any,
          ) => globalThis.Number(e))
          : [],
      byPercentileByMfnSimulatedPercentileMajorAfterWithdrawalsAllocationSavingsPortfolioX10000:
        globalThis.Array.isArray(
          ...
          : globalThis.Array.isArray(
              object
                ?.by_percentile_by_mfn_simulated_percentile_major_after_withdrawals_allocation_savings_portfolio_x10000,
            )
          ? object.by_percentile_by_mfn_simulated_percentile_major_after_withdrawals_allocation_savings_portfolio_x10000
      ...
      byPercentileByMfnSimulatedPercentileMajorAfterWithdrawalsAllocationTotalPortfolioOrZeroIfNoWealthX10000:
        globalThis.Array.isArray(
          ...
          : globalThis.Array.isArray(
              object
                ?.by_percentile_by_mfn_simulated_percentile_major_after_withdrawals_allocation_total_portfolio_or_zero_if_no_wealth_x10000,
            )
          ? object
            .by_percentile_by_mfn_simulated_percentile_major_after_withdrawals_allocation_total_portfolio_or_zero_if_no_wealth_x10000
            .map((e: any) => globalThis.Number(e))
          : [],
      tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000:
        globalThis.Array.isArray(object?.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000)
          ? object.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000.map((e: any) =>
            globalThis.Number(e)
          )
          : globalThis.Array.isArray(
              object?.tpaw_by_percentile_by_mfn_simulated_percentile_major_spending_tilt_x10000000,
            )
          ? object.tpaw_by_percentile_by_mfn_simulated_percentile_major_spending_tilt_x10000000.map((e: any) =>
            globalThis.Number(e)
          )
          : [],
      byPercentileEndingBalance: globalThis.Array.isArray(object?.byPercentileEndingBalance)
        ...
        : globalThis.Array.isArray(object?.by_percentile_ending_balance)
        ? object.by_percentile_ending_balance.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
  ...
  toJSON(message: WireSimulationResultArrays): unknown {
    ...
    if (message.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000?.length) {
      obj.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000 = message
        .tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000.map((e) => Math.round(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<WireSimulationResultArrays>, I>>(object: I): WireSimulationResultArrays {
    ...
    message.byPercentileByMfnSimulatedPercentileMajorAfterWithdrawalsAllocationTotalPortfolioOrZeroIfNoWealthX10000 =
      object.byPercentileByMfnSimulatedPercentileMajorAfterWithdrawalsAllocationTotalPortfolioOrZeroIfNoWealthX10000
        ?.map((e) => e) || [];
    message.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000 =
      object.tpawByPercentileByMfnSimulatedPercentileMajorSpendingTiltX10000000?.map((e) => e) || [];
...
export const WireSimulationResultTpawNetPresentValueApproxForBalanceSheet: MessageFns<
  WireSimulationResultTpawNetPresentValueApproxForBalanceSheet
> = {
  encode(
    ...
    for (const v of message.futureSavings) {
      WireIdAndDouble.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.incomeDuringRetirement) {
      WireIdAndDouble.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.essentialExpenses) {
      WireIdAndDouble.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.discretionaryExpenses) {
      WireIdAndDouble.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  fromJSON(object: any): WireSimulationResultTpawNetPresentValueApproxForBalanceSheet {
    return {
      futureSavings: globalThis.Array.isArray(object?.futureSavings)
        ...
        : globalThis.Array.isArray(object?.future_savings)
        ? object.future_savings.map((e: any) => WireIdAndDouble.fromJSON(e))
        : [],
      incomeDuringRetirement: globalThis.Array.isArray(object?.incomeDuringRetirement)
        ...
        : globalThis.Array.isArray(object?.income_during_retirement)
        ? object.income_during_retirement.map((e: any) => WireIdAndDouble.fromJSON(e))
        : [],
      essentialExpenses: globalThis.Array.isArray(object?.essentialExpenses)
        ...
        : globalThis.Array.isArray(object?.essential_expenses)
        ? object.essential_expenses.map((e: any) => WireIdAndDouble.fromJSON(e))
        : [],
      discretionaryExpenses: globalThis.Array.isArray(object?.discretionaryExpenses)
        ...
        : globalThis.Array.isArray(object?.discretionary_expenses)
        ? object.discretionary_expenses.map((e: any) => WireIdAndDouble.fromJSON(e))
        : [],
      legacyTarget: isSet(object.legacyTarget)
        ? globalThis.Number(object.legacyTarget)
        : isSet(object.legacy_target)
        ? globalThis.Number(object.legacy_target)
        : 0,
    };
  },
...
export const WireSimulationPerformance: MessageFns<WireSimulationPerformance> = {
  encode(message: WireSimulationPerformance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireSimulationPerformance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.portfolioBalanceEstimationInMs = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.simulationInMs = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.totalInMs = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): WireSimulationPerformance {
    return {
      portfolioBalanceEstimationInMs: isSet(object.portfolioBalanceEstimationInMs)
        ...
        : isSet(object.portfolio_balance_estimation_in_ms)
        ? globalThis.Number(object.portfolio_balance_estimation_in_ms)
        : 0,
      simulationInMs: isSet(object.simulationInMs)
        ? globalThis.Number(object.simulationInMs)
        : isSet(object.simulation_in_ms)
        ? globalThis.Number(object.simulation_in_ms)
        : 0,
      totalInMs: isSet(object.totalInMs)
        ? globalThis.Number(object.totalInMs)
        : isSet(object.total_in_ms)
        ? globalThis.Number(object.total_in_ms)
        : 0,
    };
  },
...
export const WireSimulationResult: MessageFns<WireSimulationResult> = {
  encode(message: WireSimulationResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.planParamsProcessed !== undefined) {
      WirePlanParamsProcessed.encode(message.planParamsProcessed, writer.uint32(18).fork()).join();
    }
    if (message.arrays !== undefined) {
      WireSimulationResultArrays.encode(message.arrays, writer.uint32(26).fork()).join();
    }
    ...
    if (message.performance !== undefined) {
      WireSimulationPerformance.encode(message.performance, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WireSimulationResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WireSimulationResult {
    return {
      portfolioBalanceEstimationResultOpt: isSet(object.portfolioBalanceEstimationResultOpt)
        ...
        : isSet(object.portfolio_balance_estimation_result_opt)
        ? WirePortfolioBalanceEstimationResult.fromJSON(object.portfolio_balance_estimation_result_opt)
        : undefined,
      planParamsProcessed: isSet(object.planParamsProcessed)
        ? WirePlanParamsProcessed.fromJSON(object.planParamsProcessed)
        : isSet(object.plan_params_processed)
        ? WirePlanParamsProcessed.fromJSON(object.plan_params_processed)
        : undefined,
      arrays: isSet(object.arrays) ? WireSimulationResultArrays.fromJSON(object.arrays) : undefined,
      numRuns: isSet(object.numRuns)
        ? globalThis.Number(object.numRuns)
        : isSet(object.num_runs)
        ? globalThis.Number(object.num_runs)
        : 0,
      numRunsWithInsufficientFunds: isSet(object.numRunsWithInsufficientFunds)
        ...
        : isSet(object.num_runs_with_insufficient_funds)
        ? globalThis.Number(object.num_runs_with_insufficient_funds)
        : 0,
      tpawNetPresentValueApproxForBalanceSheetOpt: isSet(object.tpawNetPresentValueApproxForBalanceSheetOpt)
        ...
        : isSet(object.tpaw_net_present_value_approx_for_balance_sheet_opt)
        ? WireSimulationResultTpawNetPresentValueApproxForBalanceSheet.fromJSON(
          object.tpaw_net_present_value_approx_for_balance_sheet_opt,
        )
        : undefined,
