...
export const WireInt32Range = {
  encode(message: WireInt32Range, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.start !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireInt32Range {
...
export const WireLogDouble = {
  encode(message: WireLogDouble, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.log !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireLogDouble {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireScaleLogDouble = {
  encode(message: WireScaleLogDouble, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.scale !== undefined) {
      WireLogDouble.encode(message.scale, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireScaleLogDouble {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireStocksAndBondsDouble = {
  encode(message: WireStocksAndBondsDouble, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stocks !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireStocksAndBondsDouble {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAmountTimed = {
  encode(message: WirePlanParamsServerAmountTimed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
    ...
    if (message.monthRange !== undefined) {
      WireInt32Range.encode(message.monthRange, writer.uint32(26).fork()).ldelim();
    }
    if (message.validMonthRange !== undefined) {
      WireInt32Range.encode(message.validMonthRange, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAmountTimed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: WirePlanParamsServerAmountTimed): unknown {
    ...
    if (message.deltaEveryRecurrence?.$case === "amount") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerAmountTimed>, I>>(
    ...
    if (
      object.deltaEveryRecurrence?.$case === "percent" &&
      object.deltaEveryRecurrence?.percent !== undefined &&
      object.deltaEveryRecurrence?.percent !== null
    ) {
      message.deltaEveryRecurrence = { $case: "percent", percent: object.deltaEveryRecurrence.percent };
    }
    if (
      object.deltaEveryRecurrence?.$case === "amount" &&
      object.deltaEveryRecurrence?.amount !== undefined &&
      object.deltaEveryRecurrence?.amount !== null
    ) {
...
export const WirePlanParamsServerAmountNotTimed = {
  encode(message: WirePlanParamsServerAmountNotTimed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.isNominal !== false) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAmountNotTimed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireGlidePathIntermediate = {
  encode(message: WireGlidePathIntermediate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.month !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireGlidePathIntermediate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireGlidePath = {
  encode(message: WireGlidePath, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.now !== 0) {
      writer.uint32(9).double(message.now);
    }
    for (const v of message.intermediate) {
      WireGlidePathIntermediate.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    if (message.end !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireGlidePath {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerConstantsDefaultSWRWithdrawalConstants = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerConstantsDefaultSWRWithdrawalConstants {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerConstants = {
  encode(message: WirePlanParamsServerConstants, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerConstants {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAgesSimulationMonths = {
  encode(message: WirePlanParamsServerAgesSimulationMonths, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAgesSimulationMonths {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAgesPerson = {
  encode(message: WirePlanParamsServerAgesPerson, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAgesPerson {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAges = {
  encode(message: WirePlanParamsServerAges, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.simulationMonths !== undefined) {
      WirePlanParamsServerAgesSimulationMonths.encode(message.simulationMonths, writer.uint32(10).fork()).ldelim();
    }
    if (message.longerLivedPerson !== undefined) {
      WirePlanParamsServerAgesPerson.encode(message.longerLivedPerson, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAges {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerPortfolioBalanceUpdatedAt = {
  encode(message: WirePlanParamsServerPortfolioBalanceUpdatedAt, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerPortfolioBalanceUpdatedAt {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.updatedTo = longToNumber(reader.int64() as Long);
          continue;
        case 2:
          if (tag !== 18) {
            break;
        ...
        case 3:
          ...
          message.updatedAtTimestampMs = longToNumber(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const WirePlanParamsServerWealth = {
  encode(message: WirePlanParamsServerWealth, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.incomeDuringRetirement) {
      WirePlanParamsServerAmountTimed.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    for (const v of message.futureSavings) {
      WirePlanParamsServerAmountTimed.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerWealth {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.portfolioBalance = { $case: "updatedHere", updatedHere: longToNumber(reader.int64() as Long) };
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  toJSON(message: WirePlanParamsServerWealth): unknown {
    ...
    if (message.portfolioBalance?.$case === "notUpdatedHere") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerWealth>, I>>(object: I): WirePlanParamsServerWealth {
    const message = createBaseWirePlanParamsServerWealth();
    if (
      object.portfolioBalance?.$case === "updatedHere" &&
      object.portfolioBalance?.updatedHere !== undefined &&
      object.portfolioBalance?.updatedHere !== null
    ) {
      message.portfolioBalance = { $case: "updatedHere", updatedHere: object.portfolioBalance.updatedHere };
    }
    if (
      object.portfolioBalance?.$case === "notUpdatedHere" &&
      object.portfolioBalance?.notUpdatedHere !== undefined &&
      object.portfolioBalance?.notUpdatedHere !== null
    ) {
      message.portfolioBalance = {
        $case: "notUpdatedHere",
...
export const WirePlanParamsServerAdjustmentsToSpendingTpawAndSpawLegacy = {
  encode(
    ...
    for (const v of message.external) {
      WirePlanParamsServerAmountNotTimed.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAdjustmentsToSpendingTpawAndSpawLegacy {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAdjustmentsToSpendingTpawAndSpaw = {
  encode(
    message: WirePlanParamsServerAdjustmentsToSpendingTpawAndSpaw,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.spendingCeiling !== undefined) {
      WireBoxedDouble.encode(message.spendingCeiling, writer.uint32(10).fork()).ldelim();
    }
    if (message.spendingFloor !== undefined) {
      WireBoxedDouble.encode(message.spendingFloor, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAdjustmentsToSpendingTpawAndSpaw {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAdjustmentsToSpendingExtraSpending = {
  encode(
    message: WirePlanParamsServerAdjustmentsToSpendingExtraSpending,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    for (const v of message.essential) {
      WirePlanParamsServerAmountTimed.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.discretionary) {
      WirePlanParamsServerAmountTimed.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAdjustmentsToSpendingExtraSpending {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAdjustmentsToSpending = {
  encode(message: WirePlanParamsServerAdjustmentsToSpending, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.tpawAndSpaw !== undefined) {
      WirePlanParamsServerAdjustmentsToSpendingTpawAndSpaw.encode(message.tpawAndSpaw, writer.uint32(18).fork())
        .ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAdjustmentsToSpending {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerRiskTPAWRiskTolerance = {
  encode(message: WirePlanParamsServerRiskTPAWRiskTolerance, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.at20 !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRiskTPAWRiskTolerance {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerRiskTPAW = {
  encode(message: WirePlanParamsServerRiskTPAW, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.riskTolerance !== undefined) {
      WirePlanParamsServerRiskTPAWRiskTolerance.encode(message.riskTolerance, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRiskTPAW {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerRiskSPAW = {
  encode(message: WirePlanParamsServerRiskSPAW, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRiskSPAW {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerRiskSPAWAndSWR = {
  encode(message: WirePlanParamsServerRiskSPAWAndSWR, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stockAllocation !== undefined) {
      WireGlidePath.encode(message.stockAllocation, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRiskSPAWAndSWR {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerRiskSWR = {
  encode(message: WirePlanParamsServerRiskSWR, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRiskSWR {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: WirePlanParamsServerRiskSWR): unknown {
    ...
    if (message.withdrawal?.$case === "amountPerMonth") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerRiskSWR>, I>>(object: I): WirePlanParamsServerRiskSWR {
    const message = createBaseWirePlanParamsServerRiskSWR();
    if (
      object.withdrawal?.$case === "percentPerYear" &&
      object.withdrawal?.percentPerYear !== undefined &&
      object.withdrawal?.percentPerYear !== null
    ) {
      message.withdrawal = { $case: "percentPerYear", percentPerYear: object.withdrawal.percentPerYear };
    }
    if (
      object.withdrawal?.$case === "amountPerMonth" &&
      object.withdrawal?.amountPerMonth !== undefined &&
      object.withdrawal?.amountPerMonth !== null
    ) {
...
export const WirePlanParamsServerRisk = {
  encode(message: WirePlanParamsServerRisk, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.tpaw !== undefined) {
      WirePlanParamsServerRiskTPAW.encode(message.tpaw, writer.uint32(10).fork()).ldelim();
    }
    if (message.spaw !== undefined) {
      WirePlanParamsServerRiskSPAW.encode(message.spaw, writer.uint32(18).fork()).ldelim();
    }
    if (message.spawAndSwr !== undefined) {
      WirePlanParamsServerRiskSPAWAndSWR.encode(message.spawAndSwr, writer.uint32(26).fork()).ldelim();
    }
    if (message.swr !== undefined) {
      WirePlanParamsServerRiskSWR.encode(message.swr, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerRisk {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerExpectedReturnsForPlanningCustomStocks = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerExpectedReturnsForPlanningCustomStocks {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerExpectedReturnsForPlanningCustomBonds = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerExpectedReturnsForPlanningCustomBonds {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerExpectedReturnsForPlanningCustom = {
  encode(
    ...
    if (message.bonds !== undefined) {
      WirePlanParamsServerExpectedReturnsForPlanningCustomBonds.encode(message.bonds, writer.uint32(18).fork())
        .ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerExpectedReturnsForPlanningCustom {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerExpectedReturnsForPlanning = {
  encode(
    ...
    switch (message.empiricalAnnualNonLog?.$case) {
      ...
      case "oneOverCape20YearTipsYield":
        NoMessage.encode(message.empiricalAnnualNonLog.oneOverCape20YearTipsYield, writer.uint32(26).fork()).ldelim();
        break;
      case "historical":
        NoMessage.encode(message.empiricalAnnualNonLog.historical, writer.uint32(34).fork()).ldelim();
        break;
      ...
      case "custom":
        ...
        break;
      case "fixed":
        WireStocksAndBondsDouble.encode(message.empiricalAnnualNonLog.fixed, writer.uint32(50).fork()).ldelim();
        break;
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerExpectedReturnsForPlanning {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: WirePlanParamsServerExpectedReturnsForPlanning): unknown {
    ...
    if (message.empiricalAnnualNonLog?.$case === "conservativeEstimate20YearTipsYield") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerExpectedReturnsForPlanning>, I>>(
    ...
    const message = createBaseWirePlanParamsServerExpectedReturnsForPlanning();
    if (
      object.empiricalAnnualNonLog?.$case === "regressionPrediction20YearTipsYield" &&
    ...
    if (
      object.empiricalAnnualNonLog?.$case === "conservativeEstimate20YearTipsYield" &&
    ...
    if (
      object.empiricalAnnualNonLog?.$case === "oneOverCape20YearTipsYield" &&
    ...
    if (
      object.empiricalAnnualNonLog?.$case === "historical" &&
      object.empiricalAnnualNonLog?.historical !== undefined &&
      object.empiricalAnnualNonLog?.historical !== null
    ) {
      message.empiricalAnnualNonLog = {
        $case: "historical",
    ...
    if (
      object.empiricalAnnualNonLog?.$case === "fixedEquityPremium" &&
    ...
    if (
      object.empiricalAnnualNonLog?.$case === "custom" &&
      object.empiricalAnnualNonLog?.custom !== undefined &&
      object.empiricalAnnualNonLog?.custom !== null
    ) {
      message.empiricalAnnualNonLog = {
        $case: "custom",
        custom: WirePlanParamsServerExpectedReturnsForPlanningCustom.fromPartial(object.empiricalAnnualNonLog.custom),
      };
    }
    if (
      object.empiricalAnnualNonLog?.$case === "fixed" &&
      object.empiricalAnnualNonLog?.fixed !== undefined &&
      object.empiricalAnnualNonLog?.fixed !== null
    ) {
      message.empiricalAnnualNonLog = {
        $case: "fixed",
...
export const WirePlanParamsServerReturnStatsForPlanningStandardDeviation = {
  encode(
    message: WirePlanParamsServerReturnStatsForPlanningStandardDeviation,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.stocks !== undefined) {
      WireScaleLogDouble.encode(message.stocks, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerReturnStatsForPlanningStandardDeviation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerReturnStatsForPlanning = {
  encode(message: WirePlanParamsServerReturnStatsForPlanning, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.expectedValue !== undefined) {
      WirePlanParamsServerExpectedReturnsForPlanning.encode(message.expectedValue, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerReturnStatsForPlanning {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerHistoricalReturnsAdjustmentStandardDeviation = {
  encode(
    message: WirePlanParamsServerHistoricalReturnsAdjustmentStandardDeviation,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.bonds !== undefined) {
      WireScaleLogDouble.encode(message.bonds, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
...
export const WirePlanParamsServerHistoricalReturnsAdjustment = {
  encode(
    ...
    switch (message.overrideToFixedForTesting?.$case) {
      case "none":
        NoMessage.encode(message.overrideToFixedForTesting.none, writer.uint32(18).fork()).ldelim();
        break;
      case "toExpectedReturnsForPlanning":
        ...
        break;
      case "manual":
        WireStocksAndBondsDouble.encode(message.overrideToFixedForTesting.manual, writer.uint32(34).fork()).ldelim();
        break;
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerHistoricalReturnsAdjustment {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: WirePlanParamsServerHistoricalReturnsAdjustment): unknown {
    ...
    if (message.overrideToFixedForTesting?.$case === "toExpectedReturnsForPlanning") {
      obj.toExpectedReturnsForPlanning = NoMessage.toJSON(
        message.overrideToFixedForTesting.toExpectedReturnsForPlanning,
      );
    }
    if (message.overrideToFixedForTesting?.$case === "manual") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerHistoricalReturnsAdjustment>, I>>(
    ...
    message.standardDeviation = (object.standardDeviation !== undefined && object.standardDeviation !== null)
      ...
      : undefined;
    if (
      object.overrideToFixedForTesting?.$case === "none" &&
      object.overrideToFixedForTesting?.none !== undefined &&
      object.overrideToFixedForTesting?.none !== null
    ) {
      message.overrideToFixedForTesting = {
        $case: "none",
    ...
    if (
      object.overrideToFixedForTesting?.$case === "toExpectedReturnsForPlanning" &&
    ...
    if (
      object.overrideToFixedForTesting?.$case === "manual" &&
      object.overrideToFixedForTesting?.manual !== undefined &&
      object.overrideToFixedForTesting?.manual !== null
    ) {
      message.overrideToFixedForTesting = {
        $case: "manual",
...
export const WirePlanParamsServerSamplingMonteCarlo = {
  encode(message: WirePlanParamsServerSamplingMonteCarlo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.seed !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerSamplingMonteCarlo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsServerAdvanced = {
  encode(message: WirePlanParamsServerAdvanced, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.annualInflation?.$case) {
      case "suggested":
        NoMessage.encode(message.annualInflation.suggested, writer.uint32(26).fork()).ldelim();
        break;
      case "manual":
    ...
    switch (message.sampling?.$case) {
      case "historical":
        NoMessage.encode(message.sampling.historical, writer.uint32(42).fork()).ldelim();
        break;
      case "monteCarlo":
        WirePlanParamsServerSamplingMonteCarlo.encode(message.sampling.monteCarlo, writer.uint32(50).fork()).ldelim();
        break;
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServerAdvanced {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: WirePlanParamsServerAdvanced): unknown {
    ...
    if (message.annualInflation?.$case === "manual") {
    ...
    if (message.sampling?.$case === "monteCarlo") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePlanParamsServerAdvanced>, I>>(object: I): WirePlanParamsServerAdvanced {
    ...
    message.historicalReturnsAdjustment =
      (object.historicalReturnsAdjustment !== undefined && object.historicalReturnsAdjustment !== null)
        ...
        : undefined;
    if (
      object.annualInflation?.$case === "suggested" &&
      object.annualInflation?.suggested !== undefined &&
      object.annualInflation?.suggested !== null
    ) {
    ...
    if (
      object.annualInflation?.$case === "manual" &&
      object.annualInflation?.manual !== undefined &&
      object.annualInflation?.manual !== null
    ) {
      message.annualInflation = { $case: "manual", manual: object.annualInflation.manual };
    }
    if (
      object.sampling?.$case === "historical" &&
      object.sampling?.historical !== undefined &&
      object.sampling?.historical !== null
    ) {
      message.sampling = { $case: "historical", historical: NoMessage.fromPartial(object.sampling.historical) };
    }
    if (
      object.sampling?.$case === "monteCarlo" &&
      object.sampling?.monteCarlo !== undefined &&
      object.sampling?.monteCarlo !== null
    ) {
      message.sampling = {
        $case: "monteCarlo",
...
export const WirePlanParamsServer = {
  encode(message: WirePlanParamsServer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.evaluationTimestampMs !== 0) {
      writer.uint32(8).int64(message.evaluationTimestampMs);
    }
    if (message.constants !== undefined) {
      WirePlanParamsServerConstants.encode(message.constants, writer.uint32(18).fork()).ldelim();
    }
    if (message.ages !== undefined) {
      WirePlanParamsServerAges.encode(message.ages, writer.uint32(26).fork()).ldelim();
    }
    if (message.wealth !== undefined) {
      WirePlanParamsServerWealth.encode(message.wealth, writer.uint32(34).fork()).ldelim();
    }
    if (message.adjustmentsToSpending !== undefined) {
      WirePlanParamsServerAdjustmentsToSpending.encode(message.adjustmentsToSpending, writer.uint32(42).fork())
        .ldelim();
    }
    if (message.risk !== undefined) {
      WirePlanParamsServerRisk.encode(message.risk, writer.uint32(50).fork()).ldelim();
    }
    if (message.advanced !== undefined) {
      WirePlanParamsServerAdvanced.encode(message.advanced, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsServer {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.evaluationTimestampMs = longToNumber(reader.int64() as Long);
          continue;
        case 2:
          if (tag !== 18) {
            break;
