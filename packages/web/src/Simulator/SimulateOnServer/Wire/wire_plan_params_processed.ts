...
export const WireAmountTimedProcessedSingle = {
  encode(message: WireAmountTimedProcessedSingle, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireAmountTimedProcessedSingle {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          if (tag === 16) {
            message.valuesX100.push(longToNumber(reader.int64() as Long));
...
export const WireAmountTimedProcessedGroup = {
  encode(message: WireAmountTimedProcessedGroup, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.byId) {
      WireAmountTimedProcessedSingle.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireAmountTimedProcessedGroup {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          if (tag === 8) {
            message.totalX100.push(longToNumber(reader.int64() as Long));
...
export const WireAmountTimedProcessed = {
  encode(message: WireAmountTimedProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.wealthIncomeDuringRetirement !== undefined) {
      WireAmountTimedProcessedGroup.encode(message.wealthIncomeDuringRetirement, writer.uint32(10).fork()).ldelim();
    }
    if (message.wealthFutureSavings !== undefined) {
      WireAmountTimedProcessedGroup.encode(message.wealthFutureSavings, writer.uint32(18).fork()).ldelim();
    }
    if (message.extraExpensesEssential !== undefined) {
      WireAmountTimedProcessedGroup.encode(message.extraExpensesEssential, writer.uint32(26).fork()).ldelim();
    }
    if (message.extraExpensesDiscretionary !== undefined) {
      WireAmountTimedProcessedGroup.encode(message.extraExpensesDiscretionary, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireAmountTimedProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireHistoricalMonthlyLogReturnsAdjustedStats = {
  encode(message: WireHistoricalMonthlyLogReturnsAdjustedStats, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.log !== undefined) {
      WireStats.encode(message.log, writer.uint32(10).fork()).ldelim();
    }
    if (message.annualized !== undefined) {
      WireLogAndNonLogStats.encode(message.annualized, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireHistoricalMonthlyLogReturnsAdjustedStats {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireHistoricalMonthlyLogReturnsAdjustedInfoArgs = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireHistoricalMonthlyLogReturnsAdjustedInfoArgs {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireHistoricalMonthlyLogReturnsAdjustedInfo = {
  encode(message: WireHistoricalMonthlyLogReturnsAdjustedInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stats !== undefined) {
      WireHistoricalMonthlyLogReturnsAdjustedStats.encode(message.stats, writer.uint32(10).fork()).ldelim();
    }
    if (message.args !== undefined) {
      WireHistoricalMonthlyLogReturnsAdjustedInfoArgs.encode(message.args, writer.uint32(18).fork()).ldelim();
    }
    if (message.srcAnnualizedStats !== undefined) {
      WireLogAndNonLogStats.encode(message.srcAnnualizedStats, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireHistoricalMonthlyLogReturnsAdjustedInfo {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireHistoricalReturnsProcessed = {
  encode(message: WireHistoricalReturnsProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.monthRange !== undefined) {
      WireMonthRange.encode(message.monthRange, writer.uint32(10).fork()).ldelim();
    }
    if (message.stocks !== undefined) {
      WireHistoricalMonthlyLogReturnsAdjustedInfo.encode(message.stocks, writer.uint32(18).fork()).ldelim();
    }
    if (message.bonds !== undefined) {
      WireHistoricalMonthlyLogReturnsAdjustedInfo.encode(message.bonds, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireHistoricalReturnsProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireReturnsStatsForPlanningProcessedPart = {
  encode(message: WireReturnsStatsForPlanningProcessedPart, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.empiricalAnnualNonLogExpectedReturn !== 0) {
      writer.uint32(9).double(message.empiricalAnnualNonLogExpectedReturn);
    }
    if (message.empiricalAnnualLogVariance !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireReturnsStatsForPlanningProcessedPart {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireReturnsStatsForPlanningProcessed = {
  encode(message: WireReturnsStatsForPlanningProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stocks !== undefined) {
      WireReturnsStatsForPlanningProcessedPart.encode(message.stocks, writer.uint32(10).fork()).ldelim();
    }
    if (message.bonds !== undefined) {
      WireReturnsStatsForPlanningProcessedPart.encode(message.bonds, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireReturnsStatsForPlanningProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireAdjustmentsToSpendingProcessedTpawAndSpawLegacy = {
  encode(
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireAdjustmentsToSpendingProcessedTpawAndSpawLegacy {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireAdjustmentsToSpendingProcessedTpawAndSpaw = {
  encode(message: WireAdjustmentsToSpendingProcessedTpawAndSpaw, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.legacy !== undefined) {
      WireAdjustmentsToSpendingProcessedTpawAndSpawLegacy.encode(message.legacy, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireAdjustmentsToSpendingProcessedTpawAndSpaw {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireAdjustmentsToSpendingProcessed = {
  encode(message: WireAdjustmentsToSpendingProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.tpawAndSpaw !== undefined) {
      WireAdjustmentsToSpendingProcessedTpawAndSpaw.encode(message.tpawAndSpaw, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireAdjustmentsToSpendingProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireRiskProcessedTpaw = {
  encode(message: WireRiskProcessedTpaw, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    writer.uint32(10).fork();
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WireRiskProcessedTpaw {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WireRiskProcessed = {
  encode(message: WireRiskProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.tpaw !== undefined) {
      WireRiskProcessedTpaw.encode(message.tpaw, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): WireRiskProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePlanParamsProcessed = {
  encode(message: WirePlanParamsProcessed, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.marketDataForPresets !== undefined) {
      WireMarketDataForPresetsProcessed.encode(message.marketDataForPresets, writer.uint32(10).fork()).ldelim();
    }
    if (message.returnsStatsForPlanning !== undefined) {
      WireReturnsStatsForPlanningProcessed.encode(message.returnsStatsForPlanning, writer.uint32(18).fork()).ldelim();
    }
    if (message.historicalReturns !== undefined) {
      WireHistoricalReturnsProcessed.encode(message.historicalReturns, writer.uint32(26).fork()).ldelim();
    }
    if (message.amountTimed !== undefined) {
      WireAmountTimedProcessed.encode(message.amountTimed, writer.uint32(34).fork()).ldelim();
    }
    if (message.adjustmentsToSpending !== undefined) {
      WireAdjustmentsToSpendingProcessed.encode(message.adjustmentsToSpending, writer.uint32(42).fork()).ldelim();
    }
    if (message.risk !== undefined) {
      WireRiskProcessed.encode(message.risk, writer.uint32(50).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WirePlanParamsProcessed {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
