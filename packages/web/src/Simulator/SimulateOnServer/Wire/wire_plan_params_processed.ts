  ...
  fromJSON(object: any): WireAmountTimedProcessedSingle {
    return {
      ...
      valuesX100: globalThis.Array.isArray(object?.valuesX100)
        ...
        : globalThis.Array.isArray(object?.values_x100)
        ? object.values_x100.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): WireAmountTimedProcessedGroup {
    return {
      totalX100: globalThis.Array.isArray(object?.totalX100)
        ...
        : globalThis.Array.isArray(object?.total_x100)
        ? object.total_x100.map((e: any) => globalThis.Number(e))
        : [],
      byId: globalThis.Array.isArray(object?.byId)
        ? object.byId.map((e: any) => WireAmountTimedProcessedSingle.fromJSON(e))
        : globalThis.Array.isArray(object?.by_id)
        ? object.by_id.map((e: any) => WireAmountTimedProcessedSingle.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): WireAmountTimedProcessed {
    return {
      wealthIncomeDuringRetirement: isSet(object.wealthIncomeDuringRetirement)
        ...
        : isSet(object.wealth_income_during_retirement)
        ? WireAmountTimedProcessedGroup.fromJSON(object.wealth_income_during_retirement)
        : undefined,
      wealthFutureSavings: isSet(object.wealthFutureSavings)
        ? WireAmountTimedProcessedGroup.fromJSON(object.wealthFutureSavings)
        : isSet(object.wealth_future_savings)
        ? WireAmountTimedProcessedGroup.fromJSON(object.wealth_future_savings)
        : undefined,
      extraExpensesEssential: isSet(object.extraExpensesEssential)
        ...
        : isSet(object.extra_expenses_essential)
        ? WireAmountTimedProcessedGroup.fromJSON(object.extra_expenses_essential)
        : undefined,
      extraExpensesDiscretionary: isSet(object.extraExpensesDiscretionary)
        ...
        : isSet(object.extra_expenses_discretionary)
        ? WireAmountTimedProcessedGroup.fromJSON(object.extra_expenses_discretionary)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): WireHistoricalMonthlyLogReturnsAdjustedInfoArgs {
    return {
      empiricalAnnualNonLogExpectedReturn: isSet(object.empiricalAnnualNonLogExpectedReturn)
        ...
        : isSet(object.empirical_annual_non_log_expected_return)
        ? globalThis.Number(object.empirical_annual_non_log_expected_return)
        : 0,
      empiricalAnnualLogVariance: isSet(object.empiricalAnnualLogVariance)
        ? globalThis.Number(object.empiricalAnnualLogVariance)
        : isSet(object.empirical_annual_log_variance)
        ? globalThis.Number(object.empirical_annual_log_variance)
        : 0,
    };
  },
  ...
  fromJSON(object: any): WireHistoricalMonthlyLogReturnsAdjustedInfo {
    return {
      ...
      srcAnnualizedStats: isSet(object.srcAnnualizedStats)
        ...
        : isSet(object.src_annualized_stats)
        ? WireLogAndNonLogStats.fromJSON(object.src_annualized_stats)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): WireHistoricalReturnsProcessed {
    return {
      monthRange: isSet(object.monthRange)
        ? WireMonthRange.fromJSON(object.monthRange)
        : isSet(object.month_range)
        ? WireMonthRange.fromJSON(object.month_range)
        : undefined,
  ...
  fromJSON(object: any): WireAdjustmentsToSpendingProcessed {
    return {
      tpawAndSpaw: isSet(object.tpawAndSpaw)
        ...
        : isSet(object.tpaw_and_spaw)
        ? WireAdjustmentsToSpendingProcessedTpawAndSpaw.fromJSON(object.tpaw_and_spaw)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): WireRiskProcessedTpaw {
    return {
      riskToleranceByMfn: globalThis.Array.isArray(object?.riskToleranceByMfn)
        ...
        : globalThis.Array.isArray(object?.risk_tolerance_by_mfn)
        ? object.risk_tolerance_by_mfn.map((e: any) => globalThis.Number(e))
        : [],
      rraUnclampedAt20IncludingPosInfinity: isSet(object.rraUnclampedAt20IncludingPosInfinity)
        ...
        : isSet(object.rra_unclamped_at_20_including_pos_infinity)
        ? globalThis.Number(object.rra_unclamped_at_20_including_pos_infinity)
        : 0,
      rraUnclampedIncludingPosInfinityByMfn: globalThis.Array.isArray(object?.rraUnclampedIncludingPosInfinityByMfn)
        ...
        : globalThis.Array.isArray(object?.rra_unclamped_including_pos_infinity_by_mfn)
        ? object.rra_unclamped_including_pos_infinity_by_mfn.map((e: any) => globalThis.Number(e))
        : [],
      legacyRraIncludingPosInfinity: isSet(object.legacyRraIncludingPosInfinity)
        ...
        : isSet(object.legacy_rra_including_pos_infinity)
        ? globalThis.Number(object.legacy_rra_including_pos_infinity)
        : 0,
    };
  },
  ...
  fromJSON(object: any): WirePlanParamsProcessed {
    return {
      marketDataForPresets: isSet(object.marketDataForPresets)
        ...
        : isSet(object.market_data_for_presets)
        ? WireMarketDataForPresetsProcessed.fromJSON(object.market_data_for_presets)
        : undefined,
      returnsStatsForPlanning: isSet(object.returnsStatsForPlanning)
        ...
        : isSet(object.returns_stats_for_planning)
        ? WireReturnsStatsForPlanningProcessed.fromJSON(object.returns_stats_for_planning)
        : undefined,
      historicalReturns: isSet(object.historicalReturns)
        ? WireHistoricalReturnsProcessed.fromJSON(object.historicalReturns)
        : isSet(object.historical_returns)
        ? WireHistoricalReturnsProcessed.fromJSON(object.historical_returns)
        : undefined,
      amountTimed: isSet(object.amountTimed)
        ? WireAmountTimedProcessed.fromJSON(object.amountTimed)
        : isSet(object.amount_timed)
        ? WireAmountTimedProcessed.fromJSON(object.amount_timed)
        : undefined,
      adjustmentsToSpending: isSet(object.adjustmentsToSpending)
        ...
        ? WireAdjustmentsToSpendingProcessed.fromJSON(object.adjustments_to_spending)
        : undefined,
      risk: isSet(object.risk) ? WireRiskProcessed.fromJSON(object.risk) : undefined,
      annualInflation: isSet(object.annualInflation)
        ? globalThis.Number(object.annualInflation)
        : isSet(object.annual_inflation)
        ? globalThis.Number(object.annual_inflation)
        : 0,
    };
  },
