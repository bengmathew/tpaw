...
export const WirePortfolioBalanceEstimationArgsParamsForNonMarketAction: MessageFns<
...
> = {
  encode(
    ...
    if (message.planParams !== undefined) {
      WirePlanParamsServer.encode(message.planParams, writer.uint32(18).fork()).join();
    }
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationArgsParamsForNonMarketAction {
    return {
      ...
      actionType: isSet(object.actionType)
        ...
        ? wirePortfolioBalanceEstimationArgsNonMarketActionTypeFromJSON(object.action_type)
        : 1,
    };
  },
...
export const WirePortfolioBalanceEstimationArgs: MessageFns<WirePortfolioBalanceEstimationArgs> = {
  encode(message: WirePortfolioBalanceEstimationArgs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.planParamsForNonMarketActionsUnsorted) {
      WirePortfolioBalanceEstimationArgsParamsForNonMarketAction.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationArgs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationArgs {
    return {
      startBalance: isSet(object.startBalance)
        ? globalThis.Number(object.startBalance)
        : isSet(object.start_balance)
        ? globalThis.Number(object.start_balance)
        : 0,
      planParamsForNonMarketActionsUnsorted: globalThis.Array.isArray(object?.planParamsForNonMarketActionsUnsorted)
        ...
        : globalThis.Array.isArray(object?.plan_params_for_non_market_actions_unsorted)
        ? object.plan_params_for_non_market_actions_unsorted.map((e: any) =>
          WirePortfolioBalanceEstimationArgsParamsForNonMarketAction.fromJSON(e)
        )
        : [],
    };
...
export const WirePortfolioBalanceEstimationState: MessageFns<WirePortfolioBalanceEstimationState> = {
  encode(message: WirePortfolioBalanceEstimationState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.estimate !== 0) {
      writer.uint32(8).int64(message.estimate);
    }
    if (message.allocation !== undefined) {
      WireStockAllocation.encode(message.allocation, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.estimate = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
...
export const WirePortfolioBalanceEstimationStateChange: MessageFns<WirePortfolioBalanceEstimationStateChange> = {
  encode(message: WirePortfolioBalanceEstimationStateChange, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.start !== undefined) {
      WirePortfolioBalanceEstimationState.encode(message.start, writer.uint32(10).fork()).join();
    }
    if (message.end !== undefined) {
      WirePortfolioBalanceEstimationState.encode(message.end, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationStateChange {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const WireVTAndBNDPercentageChange: MessageFns<WireVTAndBNDPercentageChange> = {
  encode(message: WireVTAndBNDPercentageChange, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireVTAndBNDPercentageChange {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.vtX10000 = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.bndX10000 = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): WireVTAndBNDPercentageChange {
    return {
      vtX10000: isSet(object.vtX10000)
        ? globalThis.Number(object.vtX10000)
        : isSet(object.vt_x10000)
        ? globalThis.Number(object.vt_x10000)
        : 0,
      bndX10000: isSet(object.bndX10000)
        ? globalThis.Number(object.bndX10000)
        : isSet(object.bnd_x10000)
        ? globalThis.Number(object.bnd_x10000)
        : 0,
    };
  },
...
export const WirePortfolioBalanceEstimationActionArgsMarketClose: MessageFns<
...
> = {
  encode(
    ...
    if (message.percentageChangeFromLastClose !== undefined) {
      WireVTAndBNDPercentageChange.encode(message.percentageChangeFromLastClose, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationActionArgsMarketClose {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationActionArgsMarketClose {
    return {
      percentageChangeFromLastClose: isSet(object.percentageChangeFromLastClose)
        ...
        : isSet(object.percentage_change_from_last_close)
        ? WireVTAndBNDPercentageChange.fromJSON(object.percentage_change_from_last_close)
        : undefined,
    };
  },
...
export const WirePortfolioBalanceEstimationActionArgsWithdrawalAndContribution: MessageFns<
...
> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.withdrawalOrContribution = { $case: "contribution", contribution: longToNumber(reader.int64()) };
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.withdrawalOrContribution = { $case: "withdrawal", withdrawal: longToNumber(reader.int64()) };
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  toJSON(message: WirePortfolioBalanceEstimationActionArgsWithdrawalAndContribution): unknown {
    ...
    } else if (message.withdrawalOrContribution?.$case === "withdrawal") {
  ...
  fromPartial<I extends Exact<DeepPartial<WirePortfolioBalanceEstimationActionArgsWithdrawalAndContribution>, I>>(
    ...
    const message = createBaseWirePortfolioBalanceEstimationActionArgsWithdrawalAndContribution();
    switch (object.withdrawalOrContribution?.$case) {
      case "contribution": {
        if (
...
export const WirePortfolioBalanceEstimationActionArgsMonthlyRebalance: MessageFns<
...
> = {
  encode(
    ...
    if (message.allocation !== undefined) {
      WireStockAllocation.encode(message.allocation, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationActionArgsMonthlyRebalance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const WirePortfolioBalanceEstimationActionArgsPlanChangePortfolioUpdate: MessageFns<
...
> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.exactTimestampMs = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationActionArgsPlanChangePortfolioUpdate {
    return {
      ...
      exactTimestampMs: isSet(object.exactTimestampMs)
        ? globalThis.Number(object.exactTimestampMs)
        : isSet(object.exact_timestamp_ms)
        ? globalThis.Number(object.exact_timestamp_ms)
        : 0,
    };
  },
...
export const WirePortfolioBalanceEstimationActionArgsPlanChange: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationActionArgsPlanChange {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationActionArgsPlanChange {
    return {
      ...
      portfolioUpdateOpt: isSet(object.portfolioUpdateOpt)
        ...
        : isSet(object.portfolio_update_opt)
        ? WirePortfolioBalanceEstimationActionArgsPlanChangePortfolioUpdate.fromJSON(object.portfolio_update_opt)
        : undefined,
    };
  },
...
export const WirePortfolioBalanceEstimationAction: MessageFns<WirePortfolioBalanceEstimationAction> = {
  encode(message: WirePortfolioBalanceEstimationAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stateChange !== undefined) {
      WirePortfolioBalanceEstimationStateChange.encode(message.stateChange, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationAction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationAction {
    return {
      ...
      args: isSet(object.marketClose)
        ...
        : isSet(object.market_close)
        ? {
          $case: "marketClose",
          marketClose: WirePortfolioBalanceEstimationActionArgsMarketClose.fromJSON(object.market_close),
        }
        ...
        : isSet(object.withdrawal_and_contribution)
        ? {
          $case: "withdrawalAndContribution",
          withdrawalAndContribution: WirePortfolioBalanceEstimationActionArgsWithdrawalAndContribution.fromJSON(
            object.withdrawal_and_contribution,
          ),
        }
        ...
        : isSet(object.monthly_rebalance)
        ? {
          $case: "monthlyRebalance",
          monthlyRebalance: WirePortfolioBalanceEstimationActionArgsMonthlyRebalance.fromJSON(object.monthly_rebalance),
        }
        ...
        : isSet(object.plan_change)
        ? {
          $case: "planChange",
          planChange: WirePortfolioBalanceEstimationActionArgsPlanChange.fromJSON(object.plan_change),
        }
        : undefined,
      stateChange: isSet(object.stateChange)
        ? WirePortfolioBalanceEstimationStateChange.fromJSON(object.stateChange)
        : isSet(object.state_change)
        ? WirePortfolioBalanceEstimationStateChange.fromJSON(object.state_change)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<WirePortfolioBalanceEstimationAction>, I>>(
    ...
    switch (object.args?.$case) {
      case "marketClose": {
        if (object.args?.marketClose !== undefined && object.args?.marketClose !== null) {
          message.args = {
            $case: "marketClose",
      ...
      case "withdrawalAndContribution": {
        if (object.args?.withdrawalAndContribution !== undefined && object.args?.withdrawalAndContribution !== null) {
          message.args = {
            $case: "withdrawalAndContribution",
      ...
      case "monthlyRebalance": {
        if (object.args?.monthlyRebalance !== undefined && object.args?.monthlyRebalance !== null) {
          message.args = {
            $case: "monthlyRebalance",
      ...
      case "planChange": {
        if (object.args?.planChange !== undefined && object.args?.planChange !== null) {
          message.args = {
            $case: "planChange",
...
export const WirePortfolioBalanceEstimationResult: MessageFns<WirePortfolioBalanceEstimationResult> = {
  encode(message: WirePortfolioBalanceEstimationResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.startState !== undefined) {
      WirePortfolioBalanceEstimationState.encode(message.startState, writer.uint32(26).fork()).join();
    }
    for (const v of message.actions) {
      WirePortfolioBalanceEstimationAction.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WirePortfolioBalanceEstimationResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WirePortfolioBalanceEstimationResult {
    return {
      startTimestampMs: isSet(object.startTimestampMs)
        ? globalThis.Number(object.startTimestampMs)
        : isSet(object.start_timestamp_ms)
        ? globalThis.Number(object.start_timestamp_ms)
        : 0,
      endTimestampMs: isSet(object.endTimestampMs)
        ? globalThis.Number(object.endTimestampMs)
        : isSet(object.end_timestamp_ms)
        ? globalThis.Number(object.end_timestamp_ms)
        : 0,
      startState: isSet(object.startState)
        ? WirePortfolioBalanceEstimationState.fromJSON(object.startState)
        : isSet(object.start_state)
        ? WirePortfolioBalanceEstimationState.fromJSON(object.start_state)
        : undefined,
