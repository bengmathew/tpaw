...
export const WireStockAllocation: MessageFns<WireStockAllocation> = {
  encode(message: WireStockAllocation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireStockAllocation {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.stocksX100 = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): WireStockAllocation {
    return {
      stocksX100: isSet(object.stocksX100)
        ? globalThis.Number(object.stocksX100)
        : isSet(object.stocks_x100)
        ? globalThis.Number(object.stocks_x100)
        : 0,
    };
  },
...
export const WireBoxedDouble: MessageFns<WireBoxedDouble> = {
  encode(message: WireBoxedDouble, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireBoxedDouble {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const WireYearAndMonth: MessageFns<WireYearAndMonth> = {
  encode(message: WireYearAndMonth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.year !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireYearAndMonth {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.month = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const WireMonthRange: MessageFns<WireMonthRange> = {
  encode(message: WireMonthRange, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireMonthRange {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const WireStats: MessageFns<WireStats> = {
  encode(message: WireStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mean !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WireStats {
    return {
      ...
      standardDeviation: isSet(object.standardDeviation)
        ? globalThis.Number(object.standardDeviation)
        : isSet(object.standard_deviation)
        ? globalThis.Number(object.standard_deviation)
        : 0,
...
export const WireLogAndNonLogStats: MessageFns<WireLogAndNonLogStats> = {
  encode(message: WireLogAndNonLogStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.log !== undefined) {
      WireStats.encode(message.log, writer.uint32(10).fork()).join();
    }
    if (message.nonLog !== undefined) {
      WireStats.encode(message.nonLog, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WireLogAndNonLogStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): WireLogAndNonLogStats {
    return {
      ...
      nonLog: isSet(object.nonLog)
        ? WireStats.fromJSON(object.nonLog)
        : isSet(object.non_log)
        ? WireStats.fromJSON(object.non_log)
        : undefined,
    };
  },
...
export const WireIdAndDouble: MessageFns<WireIdAndDouble> = {
  encode(message: WireIdAndDouble, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WireIdAndDouble {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NoMessage: MessageFns<NoMessage> = {
  encode(_: NoMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NoMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
