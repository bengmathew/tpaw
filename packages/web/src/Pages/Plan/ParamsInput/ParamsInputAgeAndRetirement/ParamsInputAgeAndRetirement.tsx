...
import {ParamsInputAgeAndRetirementPerson} from './ParamsInputAgeAndRetirementPerson'
import {ParamsInputAgeAndRetirementWithdrawalStart} from './ParamsInputAgeAndRetirementWithdrawalStart'

export const ParamsInputAgeAndRetirement = React.memo(
  (props: ParamsInputBodyPassThruProps) => {
    ...
    return (
      <ParamsInputBody {...props} headingMarginLeft="normal">
        <div>
          <ParamsInputAgeAndRetirementPerson
            ...
            <>
              ...
              >
                ...
                <p className="mt-3">
                  ...
                  {params.people.xAxis === 'person1'
                    ? 'your'
                    : "your partner's"}{' '}
                  age.
                </p>
              </div>
              <ParamsInputAgeAndRetirementWithdrawalStart
