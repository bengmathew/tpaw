...
export const MainControls = React.memo(
  ({
    ...
    return (
      <div
        className={`${className} grid items-center md:gap-x-5 lg:gap-x-10  overflow-hidden`}
        style={{grid: ' auto / 1fr 1fr '}}
      >
        <h2 className="font-medium text-center text-sm sm:text-base sm:text-left  whitespace-nowrap">
          Stock Allocation
        </h2>
        <h2 className="font-medium text-center  text-sm sm:text-base sm:text-left  whitespace-nowrap">
          Spending Growth
