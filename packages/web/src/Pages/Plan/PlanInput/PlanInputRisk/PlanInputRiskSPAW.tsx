...
const _SpendingTiltCard = React.memo(
  ({
    ...
    const { params, defaultParams, setPlanParams } = useSimulation()
    ...
    return (
      ...
      >
        ...
        <SliderInput
          ...
          value={params.plan.risk.spaw.annualSpendingTilt}
        ...
        <button
          ...
          onClick={() =>
            handleChange(defaultParams.plan.risk.spaw.annualSpendingTilt)
          }
        >
          Reset to Default
        </button>
