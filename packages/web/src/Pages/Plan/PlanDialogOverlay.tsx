        ...
        case 'show-results':
          return (
            <_Overlay
              ...
              chartDiv={chartDiv}
              elementId="planChartDialogCurtionShowResultsButton"
              padding={{ horz: 0, vert: 0 }}
              // Need a fill to make clickable (at least on chrome.)
              fill={ChartUtils.color.withOpacity(
                ChartUtils.color.gray[50],
                0.1,
              )}
              border={null}
          ...
          <>
            ...
            >
              ...
              <rect
                ...
                x={0}
                y={0}
                fill={ChartUtils.color.gray[300]}
