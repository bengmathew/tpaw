...
export const TasksForThisYear = React.memo(() => {
  ...
  return (
    <AppPage title="Tasks for This Year - TPAW Tasks">
      <div className="">
  ...
  ({withdrawal, isRetired, className = ''}: _Props & {className?: string}) => (
    <div className={className}>
      ...
      <p className="mb-4">
        ...
        <_Value className="">{withdrawal.availableFunds}</_Value> to
  ...
  ({withdrawal, className = ''}: _Props & {className?: string}) => (
    <div className={className}>
      ...
      <p className="">
        ...
        spend <_Value className="">{withdrawal.total}</_Value> this
      ...
      {withdrawal.fromSavings < 0 ? (
        withdrawal.src.fromIncome > 0 ? (
          <p className="mb-3">
            ...
            <_Value className="">
              {Math.abs(withdrawal.fromSavings)}
            </_Value>{' '}
            to your portfolio.{' '}
          </p>
        ) : (
      ...
      <div className={className}>
        ...
        <div className="mb-3">
          <p className="mb-3">
            ...
            The portfolio after the {isWithdrawal ? 'withdrawal' : 'contribution'}{' '}
            is <_Value className="">{allocation.balance}</_Value>.
            Rebalance the portfolio to the following asset allocation:
          </p>
          <_AllocationTable className="" {...props} />
        </div>
      </div>
