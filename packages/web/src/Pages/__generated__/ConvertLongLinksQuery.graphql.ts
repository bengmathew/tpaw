...
export type ConvertLongLinksQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"WithUser_query">;
};
export type ConvertLongLinksQuery = {
  response: ConvertLongLinksQuery$data;
  variables: ConvertLongLinksQuery$variables;
};
