...
exports.TPAWParamsV14 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Utils_1 = require("../Utils/Utils");
const Validator_1 = require("../Utils/Validator");
const DefaultParams_1 = require("./DefaultParams");
var TPAWParamsV14;
(function (TPAWParamsV14) {
    TPAWParamsV14.MAX_LABEL_LENGTH = 150;
    TPAWParamsV14.MAX_AGE = 120;
    TPAWParamsV14.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    TPAWParamsV14.fromV13 = (v13) => {
        const result = {
            ...
            risk: v13.risk.tpawPreset === 'custom'
                ? {
                    useTPAWPreset: false,
                    tpawPreset: (0, DefaultParams_1.getDefaultParams)().risk.tpawPreset,
        ...
        TPAWParamsV14.validator(result);
        return result;
    };
    // ----------- VALIDATOR  ---------//
    const _ageRange = chain(number(), _geTest(0), _leTest(TPAWParamsV14.MAX_AGE));
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV14.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _valueForYearRange = object({
        ...
        label: union(strBounded(TPAWParamsV14.MAX_LABEL_LENGTH), constant(null)),
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV14.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
    ...
    TPAWParamsV14.validator = chain(object({
        v: constant(14),
...
})(TPAWParamsV14 = exports.TPAWParamsV14 || (exports.TPAWParamsV14 = {}));
//# sourceMappingURL=TPAWParamsV14.js.map