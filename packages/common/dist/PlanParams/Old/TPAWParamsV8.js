...
exports.TPAWParamsV8 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV8;
(function (TPAWParamsV8) {
    TPAWParamsV8.MAX_LABEL_LENGTH = 150;
    TPAWParamsV8.MAX_AGE = 120;
    TPAWParamsV8.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    // ---------- FROM V7 ------------//
    TPAWParamsV8.fromV7 = (params) => {
        const result = {
            ...params,
            sampling: 'monteCarlo',
            v: 8,
        };
        TPAWParamsV8.validator(result);
        return result;
    };
    // ----------- VALIDATOR  ---------//
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV8.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV8.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    TPAWParamsV8.validator = chain(object({
        v: constant(8),
...
})(TPAWParamsV8 = exports.TPAWParamsV8 || (exports.TPAWParamsV8 = {}));
//# sourceMappingURL=TPAWParamsV8.js.map