...
exports.TPAWParamsV10 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV10;
(function (TPAWParamsV10) {
    TPAWParamsV10.MAX_LABEL_LENGTH = 150;
    TPAWParamsV10.MAX_AGE = 120;
    TPAWParamsV10.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    // ---------- FROM V9 ------------//
    TPAWParamsV10.fromV9 = (params) => {
        const result = {
            ...params,
            returns: {
                ...params.returns,
                expected: { type: 'manual', ...params.returns.expected },
            },
            v: 10,
        };
        TPAWParamsV10.validator(result);
        return result;
    };
    // ----------- VALIDATOR  ---------//
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV10.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _valueForYearRange = object({
        ...
        label: union(strBounded(TPAWParamsV10.MAX_LABEL_LENGTH), constant(null)),
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV10.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    const _expected_returns = union(object({ type: constant('suggested') }), object({ type: constant('oneOverCAPE') }), object({ type: constant('regressionPrediction') }), object({ type: constant('historical') }), object({
        type: constant('manual'),
        stocks: numRangeInclusive(-0.01, 0.1),
        bonds: numRangeInclusive(-0.01, 0.1),
    }));
    TPAWParamsV10.validator = chain(object({
        v: constant(10),
...
})(TPAWParamsV10 = exports.TPAWParamsV10 || (exports.TPAWParamsV10 = {}));
//# sourceMappingURL=TPAWParamsV10.js.map