...
exports.TPAWParamsV11 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV11;
(function (TPAWParamsV11) {
    TPAWParamsV11.MAX_LABEL_LENGTH = 150;
    TPAWParamsV11.MAX_AGE = 120;
    TPAWParamsV11.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    // ---------- FROM V10 ------------//
    TPAWParamsV11.fromV10 = (params) => {
        const result = {
            ...params,
            inflation: { type: 'manual', value: params.inflation },
            v: 11,
        };
        TPAWParamsV11.validator(result);
        return result;
    };
    // ----------- VALIDATOR  ---------//
    const _ageRange = chain(number(), _geTest(0), _leTest(TPAWParamsV11.MAX_AGE));
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV11.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _valueForYearRange = object({
        ...
        label: union(strBounded(TPAWParamsV11.MAX_LABEL_LENGTH), constant(null)),
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV11.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    TPAWParamsV11.validator = chain(object({
        v: constant(11),
...
})(TPAWParamsV11 = exports.TPAWParamsV11 || (exports.TPAWParamsV11 = {}));
//# sourceMappingURL=TPAWParamsV11.js.map