...
exports.TPAWParamsV9 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV9;
(function (TPAWParamsV9) {
    TPAWParamsV9.MAX_LABEL_LENGTH = 150;
    TPAWParamsV9.MAX_AGE = 120;
    TPAWParamsV9.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV9.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV9.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    TPAWParamsV9.validator = chain(object({
        v: constant(9),
        ...
        swrWithdrawal: union(object({ type: constant('asPercent'), percent: numRangeInclusive(0, 1) }), object({ type: constant('asAmount'), amount: numIntNonNeg() })),
...
})(TPAWParamsV9 = exports.TPAWParamsV9 || (exports.TPAWParamsV9 = {}));
//# sourceMappingURL=TPAWParamsV9.js.map