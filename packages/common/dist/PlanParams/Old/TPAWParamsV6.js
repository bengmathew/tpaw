...
exports.TPAWParamsV6 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV6;
(function (TPAWParamsV6) {
    TPAWParamsV6.MAX_LABEL_LENGTH = 150;
    TPAWParamsV6.MAX_AGE = 120;
    TPAWParamsV6.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV6.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV6.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    TPAWParamsV6.validator = chain(object({
        v: constant(6),
...
})(TPAWParamsV6 = exports.TPAWParamsV6 || (exports.TPAWParamsV6 = {}));
//# sourceMappingURL=TPAWParamsV6.js.map