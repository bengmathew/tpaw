...
exports.tpawParamsV1Validator = exports.MAX_AGE_V1 = void 0;
...
// ----------- MAIN ---------//
exports.MAX_AGE_V1 = 120;
const _ageRange = chain(number(), _geTest(0), _leTest(exports.MAX_AGE_V1));
...
exports.tpawParamsV1Validator = object({
    age: _ageValidator,
    returns: object({
        expected: object({
...
//# sourceMappingURL=TPAWParamsV1Validator.js.map