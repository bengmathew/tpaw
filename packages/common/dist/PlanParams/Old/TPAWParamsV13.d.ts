...
export declare namespace TPAWParamsV13 {
    ...
    type TPAWRiskLevel = 'riskLevel-1' | 'riskLevel-2' | 'riskLevel-3' | 'riskLevel-4' | 'custom';
    type TPAWRisk = {
        tpaw: {
    ...
    const fromV12: (v12: TPAWParamsV12.Params) => Params;
