...
exports.TPAWParamsV7 = void 0;
const lodash_1 = __importDefault(require("lodash"));
const Validator_1 = require("./Validator");
var TPAWParamsV7;
(function (TPAWParamsV7) {
    TPAWParamsV7.MAX_LABEL_LENGTH = 150;
    TPAWParamsV7.MAX_AGE = 120;
    TPAWParamsV7.MAX_NUM_YEARS_IN_GLIDE_PATH = 1000;
    ...
    TPAWParamsV7.fromV6 = (params) => {
        const result = {
            ...
            display: { alwaysShowAllYears: false },
            v: 7,
        };
        TPAWParamsV7.validator(result);
        return result;
    };
    // ----------- VALIDATOR  ---------//
    const _ageRange = chain(number(), _geTest(0), _leTest(TPAWParamsV7.MAX_AGE));
    ...
    const _person = object({
        ages: _ages,
        displayName: union(strBoundedTrimmed(TPAWParamsV7.MAX_LABEL_LENGTH), constant(null)),
    });
    ...
    const _valueForYearRange = object({
        ...
        label: union(strBounded(TPAWParamsV7.MAX_LABEL_LENGTH), constant(null)),
    ...
    const _glidePath = object({
        ...
        intermediate: sizedArray(object({ year: _year, stocks: numRangeInclusive(0, 1) }), 0, TPAWParamsV7.MAX_NUM_YEARS_IN_GLIDE_PATH - 2),
        end: object({ stocks: numRangeInclusive(0, 1) }),
    });
    TPAWParamsV7.validator = chain(object({
        v: constant(7),
        ...
        returns: object({
            ...
            historical: union(object({
                ...
                adjust: union(object({ type: constant('to'), stocks: number(), bonds: number() }), object({ type: constant('by'), stocks: number(), bonds: number() }), object({ type: constant('toExpected') })),
        ...
        checkGlidePathYears(x.targetAllocation.regularPortfolio.forSPAW.intermediate);
        return x;
    });
})(TPAWParamsV7 = exports.TPAWParamsV7 || (exports.TPAWParamsV7 = {}));
//# sourceMappingURL=TPAWParamsV7.js.map