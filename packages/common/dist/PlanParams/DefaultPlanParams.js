...
exports.getDefaultPlanParams = exports.DEFAULT_SWR_WITHDRAWAL_PERCENT = exports.resolveTPAWRiskPreset = exports.TPAW_RISK_PRESETS = exports.SUGGESTED_INFLATION = exports.EXPECTED_RETURN_PRESETS = void 0;
    ...
    const allocFn = (at20of100, spendingTilt) => {
        ...
        return {
            tpaw: {
                allocation: {
                    start: {
                        stocks: lodash_1.default.round((0, Utils_1.linearFnFomPoints)(0, at100of100, 100 - 20, at20of100)(numYears), 2),
                    },
                    intermediate: [],
...
exports.getDefaultPlanParams = getDefaultPlanParams;
//# sourceMappingURL=DefaultPlanParams.js.map