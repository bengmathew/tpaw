...
import { PlanParams23 as PlanParamsPrev } from './PlanParams23'
...
export namespace PlanParams24 {
  ...
  const oneOrTwoPassGuard = (x: PlanParams | null): JSONGuard<PlanParams> =>
    object({
      ...
      timestamp: number,
      dialogPosition: cg.dialogPosition,
      people: people,
      wealth: wealth(x),
  ...
  export type TimestampedPlanParams =
    | PlanParams21.PlanParams
    | PlanParams22.PlanParams
    | PlanParamsPrev.PlanParams
    | PlanParams
