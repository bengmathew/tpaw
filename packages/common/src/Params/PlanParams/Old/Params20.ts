...
import { PlanParams19, PlanParams19 as PlanParamsPrev } from './PlanParams19'
...
import { TPAWParamsV1 } from './TPAWParamsV1'
...
import { TPAWParamsV2 } from './TPAWParamsV2'
import { TPAWParamsV3 } from './TPAWParamsV3'
...
export namespace Params20 {
    ...
    if ((x as any).v === 20) {
      ...
      const curr: Params = {
        ...
        nonPlan: {
          ...
          defaultTimezone: {
            type: 'auto',
            ianaTimezoneName: fGet(currentTime.zoneName),
          },
          dev: {
  ...
  type OldPlanParams =
    ...
    | PlanParams15.Params
    | PlanParams14.Params
    | TPAWParamsV13.Params
    | TPAWParamsV12.Params
    | TPAWParamsV11.Params
    | TPAWParamsV10.Params
    | TPAWParamsV9.Params
    | TPAWParamsV8.Params
    | TPAWParamsV7.Params
    | TPAWParamsV6.Params
    ...
    | TPAWParamsV2
    | TPAWParamsV1
  export type SomePlanParams = Params | OldPlanParams

  export const migrate = (x: OldPlanParams): Params => guard(x).force()
}
