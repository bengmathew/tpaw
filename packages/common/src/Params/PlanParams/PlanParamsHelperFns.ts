...
import { fGet, noCase, assert, PickType, assertFalse, block } from '../../Utils'
...
export namespace PlanParamsHelperFns {
  ...
  export const switchDating = (
    ...
    planParamsNorm.datingInfo.isDated
      ? toDatelessPlan(planParamsNorm, currentPortfolioBalance)
      : toDatedPlan(planParamsNorm, ianaTimezoneName)
  ...
  export const toDatedPlan = (
    ...
    const planParams = mapMonths(
      normalizePlanParamsInverse(planParamsNorm),
      _forMonth,
      _forNowMonth,
    )
